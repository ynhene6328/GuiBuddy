...
public class WindowService : IWindowService
{
    ...
    public bool ScrollToElement(IntPtr windowHandle, string targetKey, bool useRuntimeId = false)
    {
        return _repository.ScrollToElement(windowHandle, targetKey, useRuntimeId);
    }
}
